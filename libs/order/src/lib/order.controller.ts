import { Body, Controller, Get, HttpException, HttpStatus, Logger, Param, Post, Query, Request, UseGuards, } from '@nestjs/common';
import { OrderService } from './order.service';
import { CreateOrderDto, IdTransformerDto, LocationDto } from '@wow-spedoo/dto';
import { ApiKeyAuthGuard, ApiKeyDecorator } from '@wow-spedoo/auth';
...
export class OrderController {
  ...
  @Post('add')
  async addOrder(@Body() createOrder: CreateOrderDto, @ApiKeyDecorator() token) {
    try {
